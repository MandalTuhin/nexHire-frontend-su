        ...
        <header class="topbar">
          ...
          <div class="topbar-right">
            ...
            <button mat-button [matMenuTriggerFor]="profileMenu" class="profile-dropdown">
              <div class="avatar-sm">{{ user?.fullName?.charAt(0) || 'A' }}</div>
...
export class AdminLayoutComponent implements OnInit {
  ...
  menuItems: MenuItem[] = [
    ...
    { label: 'User Management',  icon: 'manage_accounts',      route: '/admin/users',              permission: 'MANAGE_ROLES' },
    { label: 'Cities',           icon: 'location_city',        route: '/admin/cities',             permission: 'MANAGE_PERMISSIONS' },
    { label: 'Branches',         icon: 'account_balance',      route: '/admin/branches',           permission: 'MANAGE_PERMISSIONS' },
    { label: 'Blocks',           icon: 'domain',               route: '/admin/blocks',             permission: 'MANAGE_PERMISSIONS' },
    { label: 'Asset Management', icon: 'computer',             route: '/admin/assets',             permission: 'VIEW_ASSETS' },
    { label: 'Projects',         icon: 'business_center',      route: '/admin/projects',           permission: 'VIEW_PROJECTS' },
    { label: 'Budgets',          icon: 'account_balance_wallet', route: '/admin/budgets',          permission: 'MANAGE_PERMISSIONS' },
    { label: 'System Settings',  icon: 'settings',             route: '/admin/settings',           permission: 'MANAGE_PERMISSIONS' },
  ];
